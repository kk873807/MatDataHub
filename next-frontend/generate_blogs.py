          ...
          {HARDCODED_POSTS.map((post, i) => (
            <div key={i} className="group flex flex-col bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden hover:shadow-xl hover:shadow-blue-900/5 transition-all">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <Link href={/blogs/} className="inline-flex items-center gap-2 text-sm font-bold text-blue-600 dark:text-blue-400 group-hover:gap-3 transition-all">
          ...
          <>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {apiBlogs.map((blog, i) => (
                <div 
                  key={i} 
                  className={g-white dark:bg-slate-900 border  p-6 rounded-3xl transition-all group flex flex-col h-full relative overflow-hidden}
                >
                  ...
                  <div className="flex justify-between items-center border-t border-slate-200 dark:border-slate-800/50 pt-4 mt-auto">
                    ...
                    <Link href={/blogs/api-} className="text-sm font-semibold text-blue-600 dark:text-blue-400 flex items-center gap-1 group-hover:gap-2 transition-all">
