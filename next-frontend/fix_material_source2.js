...
const regex = /<div className="pt-2 border-t border-slate-200 dark:border-slate-800">\s*<span className="text-slate-600 dark:text-slate-300 block text-xs">\s*Data Source\s*<\/span>\s*<span className="text-emerald-600 dark:text-emerald-400 font-medium">\s*\{material\.data_source \|\| "Verified Internal Database"\}\s*<\/span>\s*<\/div>/g;
...
content = content.replace(regex, newSource);
