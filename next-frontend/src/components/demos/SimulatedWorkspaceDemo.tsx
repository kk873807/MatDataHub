...
const STEPS: Step[] = [
  // CREATE PROJECT (0-3)
  { label: "Click 'New Workspace' to start a project", cursor: { x: 380, y: 40 }, duration: 2500, click: true },
  { label: "Enter project name: 'Chassis Assembly'", cursor: { x: 250, y: 160 }, duration: 2500 },
  { label: "Enter description: 'Main structural frame'", cursor: { x: 250, y: 210 }, duration: 2500 },
  { label: "Click 'Create Workspace'", cursor: { x: 250, y: 270 }, duration: 2500, click: true },

  // WORKSPACE NAV & BLUEPRINTS (4-7)
  { label: "Builder Nav: Toggle between Standard BOM and Blueprints", cursor: { x: 90, y: 140 }, duration: 4000 },
  { label: "Click Blueprints to integrate API-ready JSON or CSV maps", cursor: { x: 90, y: 180 }, duration: 3500, click: true },
  { label: "Upload a blueprint to overwrite assembly, or download current map", cursor: { x: 300, y: 250 }, duration: 5000 },
  { label: "Switch back to Standard BOM to add components manually", cursor: { x: 90, y: 140 }, duration: 3500, click: true },

  // STATS (8-9)
  { label: "Top Nav: Monitor Total Mass and Total Cost in real-time", cursor: { x: 290, y: 40 }, duration: 4500 },
  { label: "Top Nav: Generate a Professional PDF Engineering Report", cursor: { x: 420, y: 40 }, duration: 4500 },

  // ADD BOM COMPONENT (10-14)
  { label: "Click '+' to add a new component to your BOM", cursor: { x: 450, y: 100 }, duration: 3000, click: true },
  { label: "Enter component name: 'Cross Member'", cursor: { x: 290, y: 160 }, duration: 2500 },
  { label: "Assign material from database: AISI 304", cursor: { x: 290, y: 210 }, duration: 2500, click: true },
  { label: "Set quantity and mass: 2 pcs, 4.2 kg each", cursor: { x: 290, y: 260 }, duration: 2500 },
  { label: "Click 'Save' to add to Bill of Materials", cursor: { x: 290, y: 310 }, duration: 2500, click: true },

  // BOM VIEW (15-16)
  { label: "Component added! BOM auto-calculates weight & cost", cursor: { x: 320, y: 200 }, duration: 4500 },
  { label: "Total Mass and Cost update instantly: 20.9 kg, $20.51", cursor: { x: 290, y: 40 }, duration: 4500 },

  // CALCULATORS (17-30)
  { label: "Open Workspace Calculators for structural analysis", cursor: { x: 90, y: 240 }, duration: 4000 },
  { label: "Calculator 1: Safety Factor — input load & area", cursor: { x: 60, y: 280 }, duration: 3500, click: true },
  { label: "Result: FoS = 2.42 — Component is safe!", cursor: { x: 320, y: 360 }, duration: 4500 },
  { label: "Calculator 2: Thermal Expansion — input temps & length", cursor: { x: 120, y: 280 }, duration: 3500, click: true },
  { label: "Result: deltaL = 2.38mm expansion", cursor: { x: 320, y: 360 }, duration: 4500 },
  { label: "Calculator 3: Fatigue Life — stress amplitude input", cursor: { x: 60, y: 340 }, duration: 3500, click: true },
  { label: "Result: 1.2M cycles to failure (S-N curve)", cursor: { x: 320, y: 360 }, duration: 4500 },
  { label: "Calculator 4: Beam Deflection — length, load, moment", cursor: { x: 120, y: 340 }, duration: 3500, click: true },
  { label: "Result: max deflection = 0.97mm", cursor: { x: 320, y: 360 }, duration: 4500 },
  { label: "Calculator 5: Cost Optimizer — finds cheaper alternatives", cursor: { x: 60, y: 400 }, duration: 3500, click: true },
  { label: "Potential savings: $4.20/assembly using AISI 1020", cursor: { x: 320, y: 360 }, duration: 4500 },
  { label: "Calculator 6: Thermal Shock — survives rapid temp change?", cursor: { x: 120, y: 400 }, duration: 3500, click: true },
  { label: "Result: R = 12.4 — material can withstand thermal shock", cursor: { x: 320, y: 360 }, duration: 4500 },
...
export function SimulatedWorkspaceDemo() {
  ...
  return (
    <div className="w-full relative">
      <div className="bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 relative min-h-[500px]">
