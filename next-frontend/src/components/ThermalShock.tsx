  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="w-full">
      <div className="flex items-center gap-3 mb-4 border-b border-slate-200 dark:border-slate-700 pb-3">
        ...
        <div>
          <h3 className="font-bold text-slate-900 dark:text-white font-heading leading-tight">Thermal Shock Estimator</h3>
          <p className="text-xs text-slate-500 dark:text-slate-400">Assess fracture risk from rapid temp changes</p>
        </div>
      </div>
