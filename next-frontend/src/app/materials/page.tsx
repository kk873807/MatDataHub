  ...
  return (
    <main className="flex flex-col p-6 lg:p-10 w-full overflow-y-auto">
      <div className="w-full max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex flex-col bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 gap-5 shadow-lg">
                  ...
                  >
                    {suggestions.map((s) => (
                      <button
                        ...
                        className="w-full text-left px-5 py-3 hover:bg-slate-100 dark:hover:bg-slate-700/50 dark:bg-slate-800 transition-colors flex items-center gap-4 border-b border-slate-200 dark:border-slate-800/50 last:border-0"
                      >
          ...
          {activeFiltersCount > 0 && (
            <div className="flex flex-wrap gap-2 pt-3 border-t border-slate-200 dark:border-slate-800/50 mt-1">
              ...
              {category && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-100  dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/50 rounded-full text-xs font-medium">
                  {category}
        ...
        {isFreeCapped && (
          <div className="mt-6 p-6 rounded-2xl bg-gradient-to-r from-emerald-950/60 to-slate-900 border border-emerald-200 dark:border-emerald-800/40 text-center">
        ...
        <div className="mt-10 p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
          <div className="w-12 h-12 bg-emerald-100  dark:bg-emerald-900/30 rounded-full flex items-center justify-center shrink-0 border border-emerald-200 dark:border-emerald-800/50">
