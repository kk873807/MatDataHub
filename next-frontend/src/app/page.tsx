        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 flex flex-col">
              ...
              <div className="text-4xl font-extrabold text-slate-900 dark:text-white mb-8">&#8377;0<span className="text-sm font-medium text-slate-500 dark:text-slate-400">/lifetime</span></div>
            ...
            <div className="bg-slate-50 dark:bg-slate-900 border-2 border-indigo-500 rounded-2xl p-8 flex flex-col relative transform md:-translate-y-4 shadow-2xl shadow-indigo-900/20">
              ...
              <div className="text-4xl font-extrabold text-slate-900 dark:text-white mb-8">&#8377;499<span className="text-sm font-medium text-slate-500 dark:text-slate-400">/lifetime</span></div>
              <ul className="space-y-3 mb-8 flex-1">
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 flex flex-col">
              ...
              <div className="text-4xl font-extrabold text-slate-900 dark:text-white mb-8">&#8377;19,999<span className="text-sm font-medium text-slate-500 dark:text-slate-400">/lifetime</span></div>
              <ul className="space-y-3 mb-8 flex-1">
