    ...
    <main className="p-6 lg:p-10 w-full max-w-7xl mx-auto space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Link href="/materials" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:bg-slate-800 px-4 py-2 rounded-2xl text-sm font-semibold transition-colors flex items-center gap-2 text-slate-900 dark:text-white">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/materials" className="bg-white dark:bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl hover:bg-slate-100 dark:bg-slate-800/50 hover:border-slate-200 dark:border-slate-700 transition-all group">
          ...
          <Link href="/analytics/cbam" className="bg-white dark:bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl hover:bg-slate-100 dark:bg-slate-800/50 hover:border-slate-200 dark:border-slate-700 transition-all group">
          ...
          <Link href="/ai" className="bg-white dark:bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl hover:bg-slate-100 dark:bg-slate-800/50 hover:border-slate-200 dark:border-slate-700 transition-all group">
          ...
          <Link href="/analytics/compare" className="bg-white dark:bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl hover:bg-slate-100 dark:bg-slate-800/50 hover:border-slate-200 dark:border-slate-700 transition-all group">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-900 dark:text-white font-heading font-heading">Recent Workspaces</h2>
