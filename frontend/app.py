...
if st.session_state.current_page == "main":
    ...
    with tab_analytics:
        ...
        st.divider()
        tab_compare, tab_substitute, tab_risk = st.tabs(["⚖️ Side-by-Side Compare", "🔄 Smart AI Substitution (PRO)", "🌍 Supply Chain Risk & CBAM (ENT)"])
...
.compact-img {
    ...
    with tab_enterprise:
        ...
        if not token:
            ...
            st.markdown("### 📊 Automated Bill of Materials Enrichment")
